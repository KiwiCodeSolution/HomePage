    ...
    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <li className="flex flex-col w-fit relative overflow-hidden pb-1">
        ...
        <div className="flex flex-col gap-y-[7px]">
          <a href="tel:4065550120" className={`text-base opacity-[.6] ${hoverAnimations}`}>
            (406) 555-0120
          </a>
          ...
          <a href="tel:2395550108" className={`text-base opacity-[.6] ${hoverAnimations}`}>
            (239) 555-0108
          </a>
        </div>
      </li>
      ...
      <li className="flex flex-col w-fit relative overflow-hidden pb-1">
        ...
        <a href="email:nathan.roberts@example.com" className={`text-base opacity-[.6] ${hoverAnimations}`}>
