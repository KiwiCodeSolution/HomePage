        ...
        <div className="grid grid-cols-1">
          <div className="flex flex-col relative order-2 md:order-1">
            ...
            <ul className="grid grid-cols-2 gap-y-14 xl:mt-[40px] px-10">
              {STEPS.map((el) => (
                <motion.li
                  className={`w-[350px] min-h-[200px] ${
                    el > 2 ? "ml-auto" : "mr-auto"
                  } relative border-b-[1px] border-bg-green rounded-b-lg`}
                  key={el}
                  initial="hidden"
                  whileInView="visible"
                  custom={el * 2}
                ...
                >
                  <p className="px-2 py-4 text-2xl font-bold bg-gradient-to-b from-bg-green to-bg-blue text-txt-white rounded-tl-lg rounded-tr-3xl">
                    {t(`how.${el - 1}.title`)}
                  </p>
                  <div className="w-full h-36 border-x-[1px] border-bg-green rounded-b-lg p-2">
                    {t(`how.${el - 1}.text`)}
                  </div>
